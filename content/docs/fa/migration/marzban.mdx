...
<Tabs items={['SQLite', 'MySQL']}>
  ...
  <Tab value="MySQL">
    <div dir="rtl">
      ...
      <Callout type="info"> 
      💬 **نکته**:
      اگر قبلاً از کاربر مرزبان در url پایگاه داده استفاده کرده‌اید و متغیرهای «MYSQL_DATABASE» و «MYSQL_USER» را در فایل «.env» دارید، می‌توانید مقدار «مرزبان» را به «pasarguard» تغییر دهید. یا از کاربر «ریشه» مانند مثال بالا استفاده کنید.
      </Callout>
    </div>
  </Tab>
</Tabs>
