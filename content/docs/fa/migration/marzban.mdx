...
#### تغییر نام تمپلیت v2ray به xray

اگر از یک تمپلیت سفارشی v2ray استفاده می‌کنید، باید پوشه اون رو با این دستور تغییر بدید:
...
اگر یک TLS اینباند دارید، باید `xray_config.json` رو ویرایش کنید و پوشه‌های گواهی را از marzban به pasarguard تغییر بدید:
...
<Tabs items={['XRAY_SUBSCRIPTION_TEMPLATE', 'Xray Certificate Directories']}>
...
<Tab value="Xray Certificate Directories">
...
اما اگر از MySQL استفاده می‌کنید، باید از دیتابیس مرزبان خروجی بگیرید تا بعداً به عنوان دیتابیس پاسارگارد وارد بشه.
...
**روش جایگزین:**
می‌تونید با `phpMyAdmin` هم دیتابیس رو وارد کنید.
